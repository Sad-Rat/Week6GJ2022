...
void UI::onRender()
{
	...
	Renderer::drawQuad(Quad::createTopLeftExtents(glm::vec2(10, getWinHeight() - 10), glm::vec2(336, 70)), *timerTexture, glm::vec4(1.0f));
	Renderer::drawQuad(Quad::createTopLeftExtents(glm::vec2(getWinWidth() - 346, getWinHeight() - 10), glm::vec2(336, 70)), *scoreTexture, glm::vec4(1.0f));
